...
export default function Testimonials() {
  const testimonials = [
    {
      img: avatarIImg,
      text: "CyberShield has been a guiding light in my career journey. The AI-driven insights and personalized advice helped me gain clarity and confidence in my decisions.",
      author: "— Alexa Johnson",
    },
    {
      img: avatarIIImg,
      text: "I’ve never experienced anything like CyberShield. Its intuitive approach makes career counseling feel natural and deeply personalized, just like talking to a real mentor.",
      author: "— Sarah Williams",
    },
    {
      img: avatarIIIImg,
      text: "CyberShield’s 24/7 accessibility and expert-driven recommendations have been a game-changer. No matter the time, I always get the guidance I need.",
      author: "— Michaela Lee",
    },
    {
      img: avatarIVImg,
      text: "With CyberShield, I feel empowered in my career choices. Its AI-driven coaching gives me the confidence to take my next step with clarity and purpose.",
      author: "— Emily Davis",
    },
    {
      img: avatarVImg,
      text: "CyberShield is more than just a tool—it's a career partner. Its smart insights and tailored recommendations have truly transformed the way I plan my future.",
      author: "— David Smith",
    },
  ];
